...
eventDict = schattentanzRandomBezier(100, 3, 10, [(TopAll, 100), (BottomAll, 100)], 2, 200, accelerationArc=0.5)

eventDict = breathing(28, [(TopAll, 100), (BottomAll, 100)], 2, 200, 100, accelerationArc=0.5)
