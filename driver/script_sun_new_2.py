...
eventDict['position'].append(LightSetChannel(At(0), BottomController, [Light1, Light3], BottomChannel))
eventDict['position'].append(LightSetChannel(At(0), BottomController, [Light2, Light4], BottomChannelTwo))
...
# eventDict['time'].append(ChannelAddEffect(At(startTime), BottomController, BottomChannel, BottomStrobeBuildUpEffect, 0))
...
# eventDict['time'].append(ChannelAddEffect(At(startTime), BottomController, BottomChannelTwo, BottomStrobeBuildUpEffect, 0))
...
eventDict['time'].append(LightSetChannel(At(startTime), BottomController, [Light1, Light3], BottomChannel))
eventDict['time'].append(LightSetChannel(At(startTime), BottomController, [Light2, Light4], BottomChannelTwo))
...
dimmduration = 5.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomIntensitySettingTwo, 0, 65, int(dimmduration*10), 10, 0, 50))
# eventDict['time'].append(SettingStatic(At(startTime), TopController, TopIntensitySetting, 90))
...
eventDict['time'].append(SettingStaticFlash(At(startTime), BottomController, BottomFlashSetting, 100, 0, 240))
...
eventDict['time'].append(SettingStaticMachine(At(startTime), BottomController, BottomFlashSetting, 100, 35, 65, 20, 12))
