...
eventDict['time'].append(LightSetChannel(At(0), BottomController, [Light4,], SecondIndicatorChannel))
eventDict['time'].append(LightSetChannel(At(0), TopController, [Light3,], SecondIndicatorChannel))
