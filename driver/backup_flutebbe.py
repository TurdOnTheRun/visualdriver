...
dimmduration = 1.2
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting3, 100, 1, 95, 2, int(dimmduration*10), 10, 100, 100))
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 100, 1, 95, 2, int(dimmduration*10), 10, 100, 100))
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 100, 1, 95, 2, int(dimmduration*10), 10, 100, 100))
...
dimmduration = 1.4
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 100, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 0, 100, int(dimmduration*10), 10, 0, 100))
...
startTime = beginning + 3.83
dimmduration = 2.4
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 100, 0, int(dimmduration*10), 10, 0, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting4, 100, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting4, 65, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting4, 65, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
dimmduration = 4.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 90, 0, int(dimmduration*10), 10, 50, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 90, 0, int(dimmduration*10), 10, 50, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting4, 95, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting4, 95, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting4, 95, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
startTime = startTime + dimmduration
dimmduration = 2
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 65, 0, int(dimmduration*10), 10, 50, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 65, 0, int(dimmduration*10), 10, 50, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting4, 80, 1, 35, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 0
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting4, 95, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 90, 100))
...
dimmduration = 0.6
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 80, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting2, 0, 80, int(dimmduration*10), 10, 0, 100))
startTime = startTime + dimmduration
dimmduration = 0.2
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 80, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting2, 80, 0, int(dimmduration*10), 10, 0, 100))
...
fadeOutLength = 0.2
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 100, 1, 99, sustainSteptime, int(fadeOutLength*10), 10, 90, 100))
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 100, 1, 99, sustainSteptime, int(fadeOutLength*10), 10, 90, 100))


# explosion end
startTime = beginning + 44.1

eventDict['time'].append(ChannelSetStatic(At(startTime), TopController, TopChannelStrobe1Steptime, 67))
eventDict['time'].append(ChannelSetStatic(At(startTime), BottomController, BottomChannelStrobe1Steptime, 67))


eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), TopController, TopEffectStrobe1, BottomChannelStrobe1Steptime, BottomChannelStrobe1Darkstep, 1537))
eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), BottomController, BottomEffectStrobe1, BottomChannelStrobe1Steptime, BottomChannelStrobe1Darkstep, 1537))
...
eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), TopController, BottomEffectStrobe2, BottomChannelStrobe2Steptime, BottomChannelStrobe2Darkstep, 2626))
eventDict['time'].append(ChannelAddEffect(At(startTime), TopController, TopChannel2, BottomEffectStrobe2, 0))
...
startTime = beginning + 44.1
dimmduration = 4
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting1, 0, 100, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting3, 0, 100, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 100, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 0, 100, int(dimmduration*10), 10, 0, 100))
...
dimmduration = 3
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting1, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting2, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting3, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting4, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 100, 0, int(dimmduration*10), 10, 0, 100))
...
eventDict['time'].append(ChannelSetStatic(At(startTime), TopController, TopChannelStrobe1Steptime, 34))
eventDict['time'].append(ChannelSetStatic(At(startTime), BottomController, BottomChannelStrobe1Steptime, 34))
...
# Top
eventDict['time'].append(ChannelAddEffect(At(startTime), TopController, TopChannel4, TopEffectSubtractPercentageVibrato, 0))
# We need a strobe only on 3 (aka 7 as global)
eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), TopController, TopEffectStrobe1, TopChannelStrobe1Steptime, TopChannelStrobe1Darkstep, 5757))
...
startTime = beginning + 0
dimmduration = 0.25
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 100, int(dimmduration*20), 5, 0, 100))

# 0.25
# Right Joins
startTime = beginning + 0.25
dimmduration = 0
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 0, 100, int(dimmduration*20), 5, 0, 100))

# 1.06 - 2.16
# Fade Down
startTime = beginning + 1.06
dimmduration = 1.1
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 100, 10, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 100, 10, int(dimmduration*20), 5, 0, 100))
...
dimmduration = 1.55
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 10, 100, int(dimmduration*20), 5, 0, 100))

# 4.06 - 5.85
# Both Fade Down
startTime = beginning + 4.05
dimmduration = 1.8
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 100, 0, int(dimmduration*20), 5, 0, 100))
...
dimmduration = 0.9
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 40, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 60, 100, int(dimmduration*20), 5, 0, 100))
...
startTime = startTime + dimmduration
dimmduration = 0.4
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 0, int(dimmduration*20), 5, 0, 100))
...
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 70, 100, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 70, 100, int(dimmduration*20), 5, 0, 100))
...
startTime = startTime + dimmduration
dimmduration = 0.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 70, 0, int(dimmduration*20), 5, 0, 100))
...
dimmduration = 0.25
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 50, int(dimmduration*20), 5, 0, 100))
startTime = startTime + dimmduration
dimmduration = 0.30
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 50, 0, int(dimmduration*20), 5, 0, 100))
...
startTime = startTime + dimmduration
dimmduration = 0.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 50, int(dimmduration*20), 5, 0, 100))

# 35.3 - 36.90
# Another Small Wave, Long Fadeout
startTime = beginning + 35.3
dimmduration = 0.6
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 50, 90, int(dimmduration*20), 5, 0, 100))
startTime = startTime + dimmduration
dimmduration = 1.3
...
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 0, 100, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 0, 100, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting4, 0, 100, int(dimmduration*20), 5, 0, 100))
startTime = startTime + dimmduration
dimmduration = 0.7
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting1, 100, 0, int(dimmduration*20), 5, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting3, 100, 0, int(dimmduration*20), 5, 0, 100))
...
dimmduration = 3.5
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting4, 100, 0, int(dimmduration*20), 5, 0, 100))
...
sustainSteptime = 5
fadeOutLength = 2
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting4, 100, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 100, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 4
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 80, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 0
sustainSteptime = 3
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 60, 1, 20, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 4
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 80, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 90, 100))
...
# sustainSteptime 
sustainSteptime = 4
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 80, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 90, 100))
...
# sustainSteptime 
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 100, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting1, 60, 1, 15, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 3
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), BottomController, BottomSetting3, 60, 1, 15, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), BottomController, BottomEffectStrobe1, TopChannelStrobe1Steptime, TopChannelStrobe1Darkstep, 2424))
eventDict['time'].append(ChannelAddEffect(At(startTime), BottomController, BottomChannel2, BottomEffectStrobe1, 0))
eventDict['time'].append(ChannelAddEffect(At(startTime), BottomController, BottomChannel4, BottomEffectStrobe1, 0))
...
eventDict['time'].append(LightSetChannel(At(startTime), TopController, [Light1,Light3], TopChannel1))
eventDict['time'].append(LightSetChannel(At(startTime), TopController, [Light2,Light4], TopChannel2))
eventDict['time'].append(ChannelSetStatic(At(startTime), TopController, TopChannelStrobe1Steptime, 100))
eventDict['time'].append(ChannelSetStatic(At(startTime), TopController, TopChannelStrobe1Darkstep, 0))
eventDict['time'].append(EffectSequencedLightStrobe(At(startTime), TopController, TopEffectStrobe1, TopChannelStrobe1Steptime, TopChannelStrobe1Darkstep, 6868))
eventDict['time'].append(ChannelAddEffect(At(startTime), TopController, TopChannel2, TopEffectStrobe1, 0))
left = True
for i in range(2):
    if left:
...
# sustainSteptime 
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting1, 100, 1, 40, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
# sustainSteptime 
sustainSteptime = 5
eventDict['time'].append(SettingImpulseToBezierFadeout(At(startTime), TopController, TopSetting1, 80, 1, 30, sustainSteptime, int(fadeOutLength*10), 10, 100, 100))
...
startTime = beginning + 244.89
dimmduration = 1.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 0, 80, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 0, 80, int(dimmduration*10), 10, 0, 100))
startTime = startTime + dimmduration
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 80, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 80, 0, int(dimmduration*10), 10, 0, 100))

# 246.6 - 250.65
# Pulsating becomes full on intense
startTime = beginning + 246.6
dimmduration = 4
eventDict['time'].append(SettingBezierDimm(At(startTime), TopController, TopSetting2, 60, 95, int(dimmduration*10), 10, 0, 100))
...
dimmduration = 3
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 0, 90, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 0, 90, int(dimmduration*10), 10, 0, 100))
...
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 90, 0, int(dimmduration*10), 10, 0, 100))
...
dimmduration = 1
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 0, 60, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 0, 60, int(dimmduration*10), 10, 0, 100))

# 264.65 - 268.14
# Fade Out Strobe from left and right
startTime = beginning + 264.65
dimmduration = 3.5
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting2, 60, 0, int(dimmduration*10), 10, 0, 100))
eventDict['time'].append(SettingBezierDimm(At(startTime), BottomController, BottomSetting4, 60, 0, int(dimmduration*10), 10, 0, 100))
# eventDict['time'].append(MotorSpeed(At(startTime), 80))
...
eventDict['time'].append(SettingStatic(At(startTime), BottomController, BottomSetting4, 0))
